...
const ToggleButtonSuspend = () => {
  ...
  return (
    <button
      className="mx-4 my-2 p-2 border border-white text-white text-sm rounded-md hover:cursor-pointer hover:bg-blue-300 focus:outline-none"
      onClick={handleClick}
    >
      ...
      >
        ...
        <div className="mt-4 mb-3">
          ...
          >
            ...
            <option value="email" onClick={toggleEmail}>
              Email
            </option>
            <option value="password" onClick={togglePassword}>
              Password
            </option>
            <option value="suspend" onClick={toggleSuspend}>
              Suspend
            </option>
          </select>
          {/* Email Update */}
